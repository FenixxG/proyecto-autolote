...
exports.listar = async(req, res) => {
    ...
    try {
        await ModeloEmpleadoTelefono.findAll()
        .then(((data)=>{
            contenido.tipo = 1;
...
exports.guardar = async(req, res) => {
    ...
    if(contenido.msj.length > 0){
        ...
        try {
            await ModeloEmpleadoTelefono.create({...req.body}) // CON ... SE PASAN TODOS LOS DATOS DEL REQ.BODY
            .then((data)=>{
                contenido.tipo = 1;
                contenido.datos = data;
                enviar(200, contenido, res);
...
exports.editar = async(req, res) => {
    ...
    if(contenido.msj.length > 0){
        ...
        try {
            await ModeloEmpleadoTelefono.update(
                ({...req.body}),
                {where: {id: id}})
            .then((data)=>{
                contenido.tipo = 1;
...
exports.eliminar = async(req, res) => {
    ...
    if(contenido.msj.length > 0){
        ...
        try {
            await ModeloEmpleadoTelefono.destroy({where: {id: id}})
            .then((data)=>{
                contenido.tipo = 1;
                contenido.datos = data;
